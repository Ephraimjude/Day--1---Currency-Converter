...
async function getExchangeRate() {
    ...
    try {
        const response = await fetch(`https://currency-exchange.p.rapidapi.com/exchange?q=1&from=${fromCur.value}&to=${toCur.value}`, {
            method: 'GET',
            headers: {
                'X-RapidAPI-Key': '3af0c1cbe5msh648a921ebabf706p16ddc6jsnf5f3ee32b0d8',
        ...
        exRateTxt.innerText = "Something went wrong, try again...";
    }
}
